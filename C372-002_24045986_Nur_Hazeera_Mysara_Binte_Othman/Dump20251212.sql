...
CREATE TABLE `cart` (
  ...
  KEY `idx_cart_perfume` (`perfumeId`),
  CONSTRAINT `fk_cart_perfume` FOREIGN KEY (`perfumeId`) REFERENCES `perfumes` (`perfumeId`) ON DELETE CASCADE,
...
INSERT INTO `cart` VALUES (3,1,1,1),(4,1,2,2);
...
INSERT INTO `reviews` VALUES (1,1,1,2,'it isnt as good as i thought','2025-12-11 15:20:45');
...
INSERT INTO `vouchers` VALUES (1,'12345','its the best discount!!','fixed',2.50,'2025-12-30',7000,0);
...
CREATE TABLE `wishlist` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_user_perfume` (`userId`,`perfumeId`),
  KEY `idx_wishlist_user` (`userId`),
  KEY `idx_wishlist_perfume` (`perfumeId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-12 11:35:52
